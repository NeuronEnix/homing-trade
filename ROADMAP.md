...
Progress: 2/10 _(v2 schema + decision provenance + risk_events + selfquery + llm replay fields (next_check_in_sec/requested_charts) all wired. Remaining: trade slippage, regime/vol/version tagging, regimes & trade_outcomes tables + embargo, Hierarchy-of-Truth doc)_
