...
Progress: 4/10 _(v2+v3 schema; decision provenance + regime/vol tagging + risk_events + selfquery + llm replay fields + trade slippage + regimes table all wired. Remaining: trade_outcomes table + embargo, Hierarchy-of-Truth doc, prompt-version tagging (Phase 4))_
